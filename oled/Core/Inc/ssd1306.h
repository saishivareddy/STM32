...
#define SSD1306_CursorShift 0x10
#define SSD1306_DisplayMove 0x08
#define SSD1306_MoveLeft 0x00
#define SSD1306_MoveRight 0x04s
...
void ssd1306_DrawRectangle(uint8_t x1, uint8_t y1, uint8_t x2, uint8_t y2,
		SSD1306_COLOR color);
void ssd1306_scrolldisplayleft();
/**
